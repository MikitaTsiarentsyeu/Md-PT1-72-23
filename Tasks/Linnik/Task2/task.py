...
# [5;20] минут
    ...
    if hh_mm[1] == 1:
        print(f'{user_time} - одна минута {numbers[hh_mm[0]+1][1]}')
    elif hh_mm[1] == 2:
        print(f'{user_time} - две минуты {numbers[hh_mm[0] + 1][1]}')
    elif hh_mm[1] in [3, 4]:
        print(f'{user_time} - {numbers[hh_mm[0]][0]} минуты {numbers[hh_mm[0] + 1][1]}')
    # elif
...
# :} min == 30: половина такого-то (15:30 - половина четвёртого)
    ...
    if hh_mm[0] > 12:
        hh_mm[0] = hh_mm[0] - 12
    print(f'{user_time} - половина {numbers[hh_mm[0]+1][1]}')
